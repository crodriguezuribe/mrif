<template>
  <div class="contact">
    ...
    <div class="container-fluid">
        <div class="row">
          <div class="col">
            <h5>Información de Contato</h5>
            <iframe width="600" height="350" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://www.openstreetmap.org/export/embed.html?bbox=-74.0483343601227%2C4.681625571043901%2C-74.04385507106782%2C4.68385506643702&amp;layer=mapnik" style="border: 1px solid black"></iframe>
            <br /><br />
            <p>Razón Social S.A.</p>
            <p>Calle 99 # 11B-20<br />
            Casa Sin Fin<br />
            Teléfono:+57 (601) XXX-XXXX<br />
            Celular:+57 (300) XXX-XXXX<br />
            E-mail: mail@dominio.com<br />
            Bogota D.C., Colombia</p>
            <hr>
            <p>John Charo - CIO<br />
            Celular:+57 (300) XXX-XXXX<br />
            <p>Henry Delgado - COO<br />
            Celular:+57 (300) XXX-XXXX<br />
            <p>Juan García - CTO<br />
            Celular:+57 (300) XXX-XXXX<br />
            <p>Francisco Meneces - CFO<br />
            Celular:+57 (300) XXX-XXXX<br />
            <p>Carlos Rodríguez - CEO<br />
            Celular:+57 (300) XXX-XXXX</p>
          </div>
          <div class="col">
            <h5>Formulario de Contacto</h5>
            Llena el formulario y nos comunicaremos contigo
            <form class="row g-3">
              <fieldset disabled="disabled">
                <div class="row g-3">
                  <div class="col">
                    <label for="inputEmail4" class="form-label">Nombre</label>
                    <input type="text" class="form-control" placeholder="Nombre" aria-label="First name" id="inputName4">
                  </div>
                  <div class="col">
                    <label for="inputEmail4" class="form-label">Apellido</label>
                    <input type="text" class="form-control" placeholder="Apellido" aria-label="Last name"  id="inputLastname4">
                  </div>
                </div>
                <div class="col-md-6">
                  <label for="inputEmail4" class="form-label">Correo Electrónico</label>
                  <input type="email" class="form-control" id="inputEmail4" placeholder="login@dominio.com">
                </div>
                <div class="col-md-6">
                  <label for="inputPassword4" class="form-label">Teléfono (Móvil o Fijo)</label>
                  <input type="text"  class="form-control" id="inputPhone4" placeholder="+57 (XXX) XXX-XXXX">
                </div>
                <div class="col-12">
                  <label for="inputAddress" class="form-label">Dirección</label>
                  <input type="text" class="form-control" id="inputAddress" placeholder="Cra X # Y-Z">
                  <smallest>&nbsp;</smallest>
                  <input type="text" class="form-control" id="inputAddress2" placeholder="Apartamento, Piso, Bloque">
                </div>
                <div class="col-md-5">
                  <label for="inputState" class="form-label">Departamento / Estado</label>
                ...
                <div class="col-md-5">
                  <label for="inputCity" class="form-label">Ciudad / Municipio</label>
                ...
                <div class="col-md-2">
                  ...
                  <input type="text" class="form-control" id="inputZip" placeholder="XXXXXX">
                </div>
                <div class="col-12">
